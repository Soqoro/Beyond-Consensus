...
def add_parsers(sub):
    ...
    config.add_argument("--profile", choices=("qwen35-4b-control", "qwen35-4b-reasoning", "qwen35-9b-later", "qwen35-27b-sql-competence"), default="qwen35-4b-control")
...
def dispatch(args):
    ...
    if args.command == "validation-config":
        ...
        if args.profile == "qwen35-27b-sql-competence":
